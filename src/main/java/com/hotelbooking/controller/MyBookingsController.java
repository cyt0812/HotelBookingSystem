...
//                    Platform.runLater(this::showLoginRequired);
//                    return;
//                }
//                
...
//                            .filter(b -> selectedStatus.equals(b.getStatus()))
//                            .toList();
//                }
//                
//                Platform.runLater(() -> displayBookings(bookings));
//            } catch (Exception e) {
//                e.printStackTrace();
//                Platform.runLater(() -> showError("Failed to load bookings: " + e.getMessage()));
//            }
//        }).start();
//    }
//    
