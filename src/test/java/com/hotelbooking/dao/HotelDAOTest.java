...
class HotelDAOTest {
    ...
    void createHotel_WithValidHotel_ShouldReturnHotelWithId() {
        // 准备
        Hotel hotel = new Hotel("Test Hotel", "Test City", "Test Description", 10);
    ...
    void getHotelById_WithExistingId_ShouldReturnHotel() {
        // 先创建酒店
        Hotel hotel = hotelDAO.createHotel(new Hotel("Existing Hotel", "City", "Desc", 5));
    ...
    void getAllHotels_ShouldReturnAllHotels() {
        // 准备 - 创建几个测试酒店
        hotelDAO.createHotel(new Hotel("Hotel A", "City A", "Desc A", 5));
        hotelDAO.createHotel(new Hotel("Hotel B", "City B", "Desc B", 10));
    ...
    void getHotelsByLocation_ShouldReturnMatchingHotels() {
        // 准备
        hotelDAO.createHotel(new Hotel("Hotel NY", "New York", "NY Hotel", 5));
        hotelDAO.createHotel(new Hotel("Hotel LA", "Los Angeles", "LA Hotel", 10));
        hotelDAO.createHotel(new Hotel("Another NY Hotel", "New York", "Another NY", 8));
    ...
    void updateHotel_ShouldUpdateHotelData() {
        // 准备
        Hotel hotel = hotelDAO.createHotel(new Hotel("Old Name", "Old Location", "Old Desc", 5));
    ...
    void deleteHotel_ShouldRemoveHotel() {
        // 准备
        Hotel hotel = hotelDAO.createHotel(new Hotel("To Delete", "Location", "Desc", 5));
